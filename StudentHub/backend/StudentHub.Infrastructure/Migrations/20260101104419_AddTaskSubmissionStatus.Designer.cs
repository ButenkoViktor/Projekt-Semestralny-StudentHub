...
namespace StudentHub.Infrastructure.Migrations
{
    ...
    [Migration("20260101104419_AddTaskSubmissionStatus")]
    partial class AddTaskSubmissionStatus
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StudentHub.Core.Entities.Chat.ChatMessage", b =>
                {
                    ...
                    b.HasOne("StudentHub.Core.Entities.Identity.ApplicationUser", "Sender")
                        .WithMany()
